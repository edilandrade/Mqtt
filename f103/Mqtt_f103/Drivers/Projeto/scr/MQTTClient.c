...
int sendPacket(Client* c, int length, Timer* timer)
{
    ...
    {
    	//fix do pacote do mqtt executado na issue #177 na lib do pahomqtt
    	//segue o link para maiores informa��es
    	//https://github.com/eclipse/paho.mqtt.embedded-c/issues/177
